...
void drawBox(int x, int y)
{
  ...
  rotateY((x - 32768) / 32768.0);
  rotateX((32768 - y) / 32768.0);
  noFill();  
  box(100);
  popMatrix();
}
...
void drawJoystick(int X, int Y)
{
  ...
  text("X: " + x, width - 124 - 40, height - 20);
  text("Y: " + y, width - 64 - 20, height - 20);
  ...
  posX = posX + (x - 32768) * (radiusOuter - radiusInner) / 32768;
  posY = posY + (y - 32768) * (radiusOuter - radiusInner) / 32768;
  fill(32, 32, 32);
